...
var JsonField = function (_a) {
    ...
    return React__default.createElement(ReactJson, __assign({}, reactJsonOptions, { src: src || {} }));
};
...
var JsonInput = function (props) {
    var _a = useInput(props), _b = _a.input, value = _b.value, onChange = _b.onChange, _c = _a.meta, touched = _c.touched, error = _c.error, isRequired = _a.isRequired;
