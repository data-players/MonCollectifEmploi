...
var ReactJson__default = /*#__PURE__*/_interopDefaultLegacy(ReactJson);
...
var JsonField = function (_a) {
    var source = _a.source, _b = _a.record, record = _b === void 0 ? {} : _b, _c = _a.jsonString, jsonString = _c === void 0 ? false : _c, _d = _a.reactJsonOptions, reactJsonOptions = _d === void 0 ? {} : _d;
    var src = get_1(record, source);
    if (jsonString) {
        src = JSON.parse(src);
    }
    return React__default['default'].createElement(ReactJson__default['default'], __assign({}, reactJsonOptions, { src: src || {} }));
};
...
var FormHelperText$1 = withStyles(styles, {
  name: 'MuiFormHelperText'
})(FormHelperText);

var JsonInput = function (props) {
    var _a = reactAdmin.useInput(props), _b = _a.input, value = _b.value, onChange = _b.onChange, _c = _a.meta, touched = _c.touched, error = _c.error, isRequired = _a.isRequired;
    var source = props.source, label = props.label, helperText = props.helperText, _d = props.jsonString, jsonString = _d === void 0 ? false : _d, reactJsonOptions = props.reactJsonOptions;
    function change(updatedSrc) {
        var updatedValue = updatedSrc;
        if (jsonString) {
            updatedValue =
    ...
    function onEdit(edit) {
        ...
        if (reactJsonOptions === null || reactJsonOptions === void 0 ? void 0 : reactJsonOptions.onEdit) {
            reactJsonOptions.onEdit(edit);
        }
    }
    function onAdd(add) {
        change(add.updated_src);
        if (reactJsonOptions === null || reactJsonOptions === void 0 ? void 0 : reactJsonOptions.onAdd) {
            reactJsonOptions.onAdd(add);
        }
    }
    function onDelete(del) {
        change(del.updated_src);
        if (reactJsonOptions === null || reactJsonOptions === void 0 ? void 0 : reactJsonOptions.onDelete) {
    ...
    return (React__default['default'].createElement("div", null,
        React__default['default'].createElement(reactAdmin.Labeled, { source: source, label: label, isRequired: isRequired },
            React__default['default'].createElement(ReactJson__default['default'], __assign({}, reactJsonOptions, { src: src || {}, onEdit: (reactJsonOptions === null || reactJsonOptions === void 0 ? void 0 : reactJsonOptions.onEdit) === false ? false : onEdit, onAdd: (reactJsonOptions === null || reactJsonOptions === void 0 ? void 0 : reactJsonOptions.onAdd) === false ? false : onAdd, onDelete: (reactJsonOptions === null || reactJsonOptions === void 0 ? void 0 : reactJsonOptions.onDelete) === false ? false : onDelete }))),
        React__default['default'].createElement(FormHelperText$1, { error: !!(touched && error) },
            React__default['default'].createElement(reactAdmin.InputHelperText, { touched: !!touched, error: error, helperText: helperText }))));
};
